...
import { ClaimModal } from '../../customer/ordenes/ClaimModal';

const Reportes = () => {
  const { claims, setPage, totalPages, totalItems, dateFilterMethods, onSeachDateFilter,
    clearFilters, otherFilterMethods, onSearchOtherFilter, claimModal, setClaimModal } = useActions();
  ...
  return (
    <>
      ...
      <ClaimModal open={claimModal} setOpen={setClaimModal} claim={claimModal} />
      <Modal
        size={'xl'}
        centered
        opened={opened}
