        ...
        <div className="flex flex-col gap-6 italic px-10 lg:px-20 font-[poppins]">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex justify-between w-full max-w-[300px]">
              <div>
                Croissant de Pollo <span className="font-semibold">RD$50</span>
              </div>
            ...
            <div className="flex justify-between w-full max-w-[300px]">
              <div>
                Croissant de Queso <span className="font-semibold">RD$50</span>
              </div>
              <button className="p-1 bg-orange-400 rounded-full active:scale-95">
                <FiPlus className="text-white" />
              </button>
            ...
            <div className="flex justify-between w-full max-w-[300px]">
              <div>
                Pan de Agua <span className="font-semibold">RD$50</span>
              </div>
              <button className="p-1 bg-orange-400 rounded-full active:scale-95">
                <FiPlus className="text-white" />
              </button>
            ...
            <div className="flex justify-between w-full max-w-[300px]">
              <div>
                Pan Sobao <span className="font-semibold">RD$50</span>
              </div>
              <button className="p-1 bg-orange-400 rounded-full active:scale-95">
                <FiPlus className="text-white" />
              </button>
