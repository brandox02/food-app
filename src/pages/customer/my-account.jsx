    ...
    <div className="w-full ">
      ...
      <div className="w-full max-w-[1750px] mx-auto lg:px-24 px-5 grid md:grid-cols-4 gap-5">
        <div className=" grid w-full md:col-span-3 gap-5 order-2 md:order-1">
          ...
          >
            <Tabs.List className="px-10 mb-3 flex justify-center md:justify-start">
              <Tabs.Tab
            ...
            <Tabs.Panel
              ...
              pt="xs"
            >
              <div className="grid lg:grid-cols-3 col-span-3 gap-x-5 gap-y-3">
            ...
            <Tabs.Panel
              ...
              pt="xs"
            >
              <div className="grid lg:grid-cols-3 col-span-3 gap-x-5 gap-y-6">
                <div className=" lg:col-span-3 w-full">
                  <span className="text-blue-900 text-2xl font-semibold">
                    Cambiar Contraseña
                  </span>
        ...
        <div className="w-full bg-white md:mt-[45px] rounded-md order-1">
          <div className="flex flex-col items-center gap-4 py-12 h-full">
            <div className="min-w-[140px] h-[140px] rounded-full ring-2 ring-sky-600 relative">
              <Image
                layout="fill"
