...
const Reposteria = () => {
  const items = [
    { title: <FiHome />, href: '/' },
    { title: 'Repostería', href: '/customer/pastry' },
  ].map((item, index) => (
    <Link
  ...
  return (
    <div className="w-full flex flex-col gap-6">
      <Head>
        <title>Pa&apos; Come | Repostería</title>
          ...
          <div className="flex flex-col gap-6 italic px-10 lg:px-20 font-[poppins]">
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-between w-full max-w-[300px]">
                <div>
                  Bizcocho <span className="font-semibold">RD$50</span>
                </div>
              ...
              <div className="flex justify-between w-full max-w-[300px]">
                <div>
                  Dulce de coco <span className="font-semibold">RD$50</span>
                </div>
                <button className="p-1 bg-orange-400 rounded-full active:scale-95">
                  <FiPlus className="text-white" />
                </button>
              ...
              <div className="flex justify-between w-full max-w-[300px]">
                <div>
                  Cupcake <span className="font-semibold">RD$50</span>
                </div>
                <button className="p-1 bg-orange-400 rounded-full active:scale-95">
                  <FiPlus className="text-white" />
                </button>
              ...
              <div className="flex justify-between w-full max-w-[300px]">
                <div>
                  Dulce de leche <span className="font-semibold">RD$50</span>
                </div>
                <button className="p-1 bg-orange-400 rounded-full active:scale-95">
                  <FiPlus className="text-white" />
                </button>
